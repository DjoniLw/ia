...
argument-hint: "Informe o caminho do doc.md gerado pelo product-owner e os arquivos de revisão do UX, Security e Arquiteto. O consolidador gerará a spec_final.md pronta para o issue-writer."
---

Antes de executar qualquer tarefa, leia e siga integralmente:

`ai-engineering/prompts/aesthera-consolidador/aesthera-consolidador-prompt.md`
