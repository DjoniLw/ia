...
argument-hint: "Descreva a feature ou ideia que deseja transformar em issue. O pipeline decide automaticamente se usa o fluxo completo (complexo) ou direto (simples) e executa tudo sozinho."
---

Antes de executar qualquer tarefa, leia e siga integralmente:

`ai-engineering/prompts/aesthera-pipeline/aesthera-pipeline-prompt.md`
